...
              {/* This grid now stacks on mobile and becomes 2 columns on large screens */}
...
                          <input type="tel" name="phone" id="phone" placeholder="(+55) 555-5555" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3" />
...
                            City <span className="text-gray-500">(required)</span>

                          </label>

                          <input type="city" name="city" id="city" required placeholder="Almaty" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3" />
...
                          <input type="title" name="title" id="title" required placeholder="Developer" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3" />
...
                          <input type="Company" name="Company" id="Company" required placeholder="Apple" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3" />
